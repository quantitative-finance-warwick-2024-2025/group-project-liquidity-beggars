...
// Set the ask quote based on the current belief and model parameters
...
// Set the bid quote based on the current belief and model parameters
...
// Update the market maker's belief after observing a buy or sell trade
...
int main() {
    try {
        ...
        const double meanQuantity = 5.0;         // Average order size
